...
public class Subjects {
 ...
 public void newsubject(int studid, String studname, String studadd,
    ...
    public void delete_subject(int studid){
        EnrollmentSystem b = new EnrollmentSystem();
    b.DBConnect();
    ...
    public void update_subject(int studid, String studname, String studadd,
                   String studcrs, String studgender, String studyrlvl){
    EnrollmentSystem b = new EnrollmentSystem();
    b.DBConnect();
